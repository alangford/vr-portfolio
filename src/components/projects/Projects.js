...
const Projects = () => [
  ...
  <a-assets>
    ...
    <a-image href='https://adobe.andrewlangford.net' src="#ADOBE" position='-3 1 -9.5' />,
    ...
    <a-image href='https://pong.andrewlangford.net' src="#PONG" position='1 1 -9.5' />,
    <Entity text={{value: 'A Heat Map App', height:"5", width:"5", align: 'center'}} rotation='0 0 0' position={{x: 3, y: 2, z: -9}}/> ,
    <a-image href='https://seek.andrewlangford.net' src="#SEEK" position='3 1 -9.5' />,
    ...
    <a-image href='https://tetris.andrewlangford.net' src="#TETRIS" position='0 4 -9.5' />,
    <Entity text={{value: 'w3schools clone', height:"5", width:"5", align: 'center'}} rotation='0 0 0' position={{x: 3, y: 5, z: -9}}/> ,
    <a-image href='https://w3clone.andrewlangford.net' src="#W3" position='3 4 -9.5' />,
